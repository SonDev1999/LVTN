...
--
-- Host: localhost:3306
-- Generation Time: Nov 06, 2021 at 05:39 AM
...
INSERT INTO `loaisanpham` (`id`, `loai_ten`) VALUES
(1, 'Điện thoại'),
(2, 'Máy tính bảng'),
(3, 'Laptop'),
(4, 'Âm thanh'),
...
INSERT INTO `sanpham` (`id`, `id_loai`, `id_nhasanxuat`, `id_khuyenmai`, `sanpham_ten`, `hinh`) VALUES
(6, 1, 4, 1, 'iPhone 13 Pro Max 256GB', 'iphone_13-_pro-5_4_1.jpg'),
(7, 3, 1, 2, 'Laptop ASUS Zephyrus Duo 15 SE GX551QR-HB120T', 'laptop-asus-rog-zephyrus-duo-15-se-gx551qr-hb120t-1-ksp.jpg'),
(8, 2, 3, 1, 'Samsung Galaxy Tab S7 Plus', 'samsung-galaxy-tab-s7-plus-3.jpg'),
(9, 5, 5, 2, 'Xiaomi Mi Watch Lite', 'mi-watch-lite_1.jpg'),
...
--
ALTER TABLE `chitietthuoctinh`
  ADD CONSTRAINT `chitietthuoctinh_ibfk_1` FOREIGN KEY (`id_sanpham`) REFERENCES `sanpham` (`id`),
