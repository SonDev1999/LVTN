...
<head>
    ...
    <link href="{{asset('public/back-end/images/favicon.png')}}" rel="icon" type="image/png" sizes="16x16">
    <link href="{{asset('public/back-end/vendor/jqvmap/css/jqvmap.min.css')}}" rel="stylesheet">
    <link href="{{asset('public/back-end/vendor/chartist/css/chartist.min.css')}}" rel="stylesheet">
    <link href="{{asset('public/back-end/bootstrap-select/dist/css/bootstrap-select.min.css')}}" rel="stylesheet">
    <link href="{{asset('public/back-end/css/style.css')}}" rel="stylesheet">
    <link href="{{asset('public/back-end/css/main1.css')}}" rel="stylesheet">
    <link href="{{asset('../../cdn.lineicons.com/2.0/LineIcons.cs')}}" rel="stylesheet">


    <!-- Datatable -->
    <link href="{{asset('public/back-end/vendor/datatables/css/jquery.dataTables.min.css')}}" rel="stylesheet">
    <!-- Custom Stylesheet -->
...
<body>
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body">
            <!-- row -->
            <div class="container-fluid" id="load_content">
                @yield('content_star')
            </div>
        </div>
        <!--**********************************
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by <a href="https://www.facebook.com/" target="_blank">Lê Quang Đức</a> 2021</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    ...
    <script src="{{asset('public/back-end/vendor/chart.js/Chart.bundle.min.js')}}"></script>
    <script src="{{asset('public/back-end/js/custom.min.js')}}"></script>
    <script src="{{asset('public/back-end/js/deznav-init.js')}}"></script>
    <!-- Apex Chart -->
    <script src="{{asset('public/back-end/vendor/apexchart/apexchart.js')}}"></script>
    <!-- Vectormap -->
    <!-- Chart piety plugin files -->
    <script src="{{asset('public/back-end/vendor/peity/jquery.peity.min.js')}}"></script>
    <!-- Chartist -->
    <script src="{{asset('public/back-end/vendor/chartist/js/chartist.min.js')}}"></script>
    <!-- Dashboard 1 -->
    <script src="{{asset('public/back-end/js/dashboard/dashboard-2.js')}}"></script>
    <!-- Svganimation scripts -->
    <script src="{{asset('public/back-end/vendor/svganimation/vivus.min.js')}}"></script>
    <script src="{{asset('public/back-end/vendor/svganimation/svg.animation.js')}}"></script>
