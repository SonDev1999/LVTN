                            ...
                            <li class="expand"><a href="shop-grid.html">Man</a>
                                <div class="restrain mega-menu megamenu1">
                                    ...
                                    <span class="block-last">
                                        <img src="{{url('resources')}}/img/block_menu.jpg" alt="" />
                                    </span>
                                </div>
                            </li>
                        ...
                        <div class="circle-shopping expand">
                            <div class="shopping-carts text-right">
                                <div class="cart-toggler">
                                    <a href="{{route('get.list.shopping')}}"><i class="icon-bag"></i></a>
                                    <a href="{{route('get.list.shopping')}}"><span class="cart-quantity">{{\Cart::count()}}</span></a>
                                </div>
