                        ...
                        <div class="circle-shopping expand">
                            <div class="shopping-carts text-right">
                                <div class="cart-toggler">
                                    <a href="{{route('gio.hang')}}"><i class="icon-bag"></i></a>
                                    <a href="{{route('gio.hang')}}"><span class="cart-quantity">{{\Cart::count()}}</span></a>
                                </div>
                                      ...
                                      {{dd($sanpham)}}
                                        <li>
                                            <a class="sm-cart-product" href="product-details.html">
                                                <img src="{{ url('resources') }}/img/products/{{ $item->options->avatar }}"
                                                    alt="">
                                            </a>
                                            <div class="small-cart-detail">
                                                ...
                                                <a href="#" class="edit-btn"><img
                                                        ...
                                                        alt="Edit Button" /></a>
                                                <a class="small-cart-name" href="product-details.html">{{$item->name}}</a>
                                                <span
                                                    class="quantitys"><strong>{{$item->qty}}</strong>x<span>{{number_format($item->price)}} VNĐ</span></span>
                                            </div>
                                        </li>
                                       @endforeach
                                    </ul>
